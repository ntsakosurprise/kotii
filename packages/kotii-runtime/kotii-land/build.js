...
const ClientRoutes = (props) => {
  ...
  let refinedRoutes = astRoutes.map((r, index) => {
    ...
    return {
      component: () =>
        /*#__PURE__*/ React.createElement(ComponentWrapped, null),
      path: r.path,
  ...
  if (markRoutes.length > 0) {
    markRoutes.forEach((route, index) => {
      ...
      refinedRoutes.push({
        ...
        path: route.path,
        isPrivate:
          (route === null || route === void 0 ? void 0 : route.isPrivate) ||
          false,
      });
    });
  }
...
const RoutesAsServerRoutes = (props) => {
  ...
  const gRoutes =
    (goodies === null || goodies === void 0 ? void 0 : goodies.routes) || [];
  const gComps =
    (goodies === null || goodies === void 0 ? void 0 : goodies.comps) || {};
  const markRoutes =
    (goodies === null || goodies === void 0
      ? void 0
      : goodies.markdownRoutes) || [];
  const MarkdownRendr =
    (goodies === null || goodies === void 0
      ? void 0
      : goodies.MarkdownRender) || null;
  const posts = {};
  const { layout } = useAppContext();
  const Layout = layout
    ? layout
