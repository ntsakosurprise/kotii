  ...
  return (
    <div className="footer__company">
      <section className="footer__brand footer__tool">
        <img
          src="/img/ioco_footer.png"
          alt="ioco footer logo"
          className="footer__brand--logo"
        />
        <span className="footer__brand--text">
          iOCO is the ICT services brand of the EOH Group
        </span>
      </section>
      ...
      <section className="footer__business footer__tool">
        ...
        <a
          href="https://www.google.com/maps/place/EOH/@-26.1740667,28.1259228,17z/data=!4m12!1m6!3m5!1s0x1e95121b7622edc3:0x478a1b07bef2abb3!2sEOH!8m2!3d-26.1740667!4d28.1281115!3m4!1s0x1e95121b7622edc3:0x478a1b07bef2abb3!8m2!3d-26.1740667!4d28.1281115"
