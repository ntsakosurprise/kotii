...
methods.showAvailableCommands = function () {
  ...
  let supportedCommands = [
    {
      name: "spa",
      description: "Run app in spa mode",
    },
    {
      name: "help",
      description: "Shows help menu for kotii-serve",
    },
    {
      name: "version",
      description: "Shows the current version of kotii-serve",
    },

    {
      name: "static",
      description: "Run the current app in static mode and serve html files",
    },
  ];
  ...
  console.log(chalk.greenBright("Supported Kotii-serve Commands:"));
  p1.printTable();
};
...
methods.help = function () {
  ...
  let commands = [
    {
      name: "kotii-serve static",
      description: "Run the current app in static mode",
    },

    {
      name: "kotii-serve spa",
      description: "Run current app in spa mode",
    },
  ...
  console.log(chalk.greenBright("kotii-serve <command> [options]"));
  console.log();
...
methods.createKotiiServveCommandHelpOption = function () {
  ...
  const commandOptions = self.commands["static"].options;
  ...
  console.log(chalk.greenBright("static <options>"));
  console.log();
  p1.printTable();
