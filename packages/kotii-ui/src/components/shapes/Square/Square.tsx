...
const StyledSquare = styled("div")((props) => {
  ...
  const styles = createJSCSSSchema(props, "square");
  console.log("The SHAPE STYLES", styles);
  return { ...styles };
});

const Square: React.FC<SquareProps> = ({ children, testID, ...props }) => {
  ...
  return (
    <StyledSquare {...newProps} theme={theme} data-testid={testID}>
