...
import { AlignAroundBetween, AnimationT, BackgroundAltType, BackgroundType, Border, BorderType, Direction, Justify, Overflow, Size, SizeNoneXs, Skeleton, Spacings } from "./types";
export interface BaseProps {
    ...
    width?: "xxsmall" | "xsmall" | Size | "xlarge" | "xxlarge" | {
        min: string;
        max: string;
    };
