...
import("/kotii-user-api/plugins").then(imported => {
  ...
  if (userPlugins !== null && userPlugins !== void 0 && userPlugins.noApi && Object.keys(userPlugins).length === 1) {
    anzii(plugins);
  } else {
    let pluginsCombined = _objectSpread(_objectSpread({}, userPlugins), plugins);
