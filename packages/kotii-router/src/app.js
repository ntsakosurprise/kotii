...
const App = () => {
  ...
  let foundPages = getPages();
  let mapsOfComps = createRouterComponents(foundPages);
  console.log("THE PAGES MAPS OF COMPS", mapsOfComps);
  console.log("THE PAGES FOUND", foundPages);
  return (
    <KotiiThemeProvider>
      <KotiiGlobal />
