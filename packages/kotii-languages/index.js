...
!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports["kotii-languages"] = t(require("react"), require("react-dom")))
    : (e["kotii-languages"] = t(e.React, e.ReactDOM));
})(self, (e, t) =>
  (() => {
    var n = {
        899: (e) => {
            ...
            (e.exports = (() => {
              ...
              e.r(t),
                e.d(t, {
                  ...
                  capitalizeLastLetter: () => a,
                  getFromStorage: () => r,
                  removeFromStorage: () => o,
                  setInStorage: () => n,
                });
              const n = (e, t) => {
                  console.log("GETTING KEY valuePairs;;;", e),
                    console.log("KEY VALUE;;;", t),
                    localStorage.setItem(e, JSON.stringify(t));
                },
                r = (e) => {
                  console.log("GETFROM STORAGE;;;", e),
                    console.log("Get from Storage;;;", localStorage.getItem(e));
                  let t = e ? localStorage.getItem(e) : null;
                  return t && t
                    ? "undefined" === t ||
                      ("object" == typeof t && 0 === Object.keys(t).length)
                      ? null
                      : (console.log("JSON PARSED ITEM;;;", JSON.parse(t)),
                        JSON.parse(t))
                    : null;
                },
                o = (e) => {
                  console.log("Removing Key from storage;;;", e),
                    localStorage.removeItem(e);
                },
                i = (e) => (
                  console.log("The text Uppercasing;;;", e),
                  `${e.slice(0, 1).toUpperCase()}${e.slice(1)}`
                ),
                a = (e) => (
                  console.log("The text Lowercasing;;;", e),
    ...
    return (
      (() => {
        ...
        function q() {
          return (
            (_ = B > 0 ? N(K, --B) : 0), $--, 10 === _ && (($ = 1), U--), _
          );
        }
        function J() {
          return (
            (_ = B < z ? N(K, B++) : 0), $++, 10 === _ && (($ = 1), U++), _
          );
        }
        function Y() {
          return N(K, B);
        ...
        function ee(e) {
          return (U = $ = 1), (z = F((K = e))), (B = 0), [];
        }
        function te(e) {
          return (K = ""), e;
        }
        function ne(e) {
          return M(Z(B - 1, ie(91 === e ? e + 2 : 40 === e ? e + 1 : e)));
        }
        function re(e) {
          for (; (_ = Y()) && _ < 33; ) J();
          return Q(e) > 2 || Q(_) > 3 ? "" : " ";
        ...
        function ae(e, t) {
          for (; J() && e + _ !== 57 && (e + _ !== 84 || 47 !== Y()); );
          return "/*" + Z(t, B - 1) + "*" + I(47 === e ? e : J());
        }
        function se(e) {
          for (; !Q(Y()); ) J();
          return Z(e, B);
          ...
          for (
            ...
            switch (((g = b), (b = J()))) {
              ...
              case 0:
                switch (b) {
                  ...
                  default:
                    if (
                      (H(
                        (S = ye(x, t, n, l, c, o, s, y, (O = []), (w = []), p)),
                        i
                      ),
                      123 === b)
                    )
                      if (0 === c) be(x, t, S, S, O, i, p, s, w);
                      else
                        switch (99 === f && 110 === N(x, 3) ? 100 : f) {
                          case 100:
                          case 108:
                          case 109:
                          case 115:
              ...
              default:
                if (h < 1)
                  if (123 == b) --h;
                  else if (125 == b && 0 == h++ && 125 == q()) continue;
                switch (((x += I(b)), b * h)) {
                  case 38:
                    m = c > 0 ? 1 : ((x += "\f"), -1);
                    break;
        ...
        function ye(e, t, n, r, o, i, a, s, u, l, c) {
          for (
            var p = o - 1,
              f = 0 === o ? i : [""],
              d = A(f),
            ...
            for (
              var m = 0, b = T(e, p + 1, (p = R((h = a[g])))), y = e;
              m < d;
              ++m
            )
              (y = M(h > 0 ? f[m] + " " + b : V(b, /&\f/g, f[m]))) &&
                (u[v++] = y);
          return W(e, t, n, 0 === o ? fe : s, u, l, c);
        }
        function Oe(e, t, n) {
          return W(e, t, n, pe, I(_), T(e, 2, -2), 0);
        }
        function we(e, t, n, r) {
          return W(e, t, n, de, T(e, 0, r), T(e, r + 1, -1), r);
        }
        var Se = function (e, t, n) {
            for (
              var r = 0, o = 0;
              (r = o), (o = Y()), 38 === r && 12 === o && (t[n] = 1), !Q(o);
          ...
          switch (
            ...
            case 5187:
              return (
                ce +
                e +
                V(e, /(\w+).+(:[^]+)/, ce + "box-$1$2" + ue + "flex-$1$2") +
                e
              );
            case 5443:
              return ce + e + ue + "flex-item-" + V(e, /flex-|-self/, "") + e;
            case 4675:
              return (
                ce +
                e +
            ...
            case 5548:
              return ce + e + ue + V(e, "shrink", "negative") + e;
            case 5292:
              return ce + e + ue + V(e, "basis", "preferred-size") + e;
            case 6060:
              return (
                ce +
                "box-" +
            ...
            case 4554:
              return ce + V(e, /([^-])(transform)/g, "$1" + ce + "$2") + e;
            case 6187:
              return (
                V(
                  V(V(e, /(zoom-|grab)/, ce + "$1"), /(image-set)/, ce + "$1"),
                  e,
                  ""
                ) + e
              );
            ...
            case 4765:
              if (F(e) - 1 - t > 6)
                switch (N(e, t + 1)) {
                  ...
                  case 115:
                    return ~D(e, "stretch")
                      ? Pe(V(e, "stretch", "fill-available"), t) + e
                      : e;
                }
              break;
            case 4949:
            ...
            case 6444:
              switch (N(e, F(e) - 3 - (~D(e, "!important") && 10))) {
                case 107:
                  return V(e, ":", ":" + ce) + e;
                case 101:
                  return (
            ...
            case 5936:
              switch (N(e, t + 11)) {
                case 114:
                  return ce + e + ue + V(e, /[svh]\w+-[tblr]{2}/, "tb") + e;
                case 108:
                  return ce + e + ue + V(e, /[svh]\w+-[tblr]{2}/, "tb-rl") + e;
                case 45:
                  return ce + e + ue + V(e, /[svh]\w+-[tblr]{2}/, "lr") + e;
              }
              return ce + e + ue + e + e;
          }
          return e;
              ...
              if (e.length > -1 && !e.return)
                switch (e.type) {
                  case de:
                    ...
                    break;
                  case ge:
                    return he([G(e, { value: V(e.value, "@", "@" + ce) })], r);
                  case fe:
                    if (e.length)
                      return (function (e, t) {
                        return e.map(t).join("");
        ...
        var Me = /[A-Z]|^ms/g,
          ...
          Te = je(function (e) {
            return De(e) ? e : e.replace(Me, "-$&").toLowerCase();
          }),
          Fe = function (e, t) {
            switch (e) {
              case "animation":
              case "animationName":
                if ("string" == typeof t)
                  return t.replace(Ve, function (e, t, n) {
                    return (He = { name: t, styles: n, next: He }), t;
                  });
            }
            return 1 === Ie[e] || De(e) || "number" != typeof t || 0 === t
              ? t
              : t + "px";
          };
        function Ae(e, t, n) {
          ...
          switch (typeof n) {
            ...
            case "object":
              ...
              return (function (e, t, n) {
                var r = "";
                if (Array.isArray(n))
                  for (var o = 0; o < n.length; o++) r += Ae(e, t, n[o]) + ";";
                else
                  for (var i in n) {
                    var a = n[i];
                    if ("object" != typeof a)
        ...
        var He,
          ...
          $e = function (e, t, n) {
            ...
            for (var a = 1; a < e.length; a++)
              (o += Ae(n, t, e[a])), r && (o += i[a]);
            Ue.lastIndex = 0;
            for (var s, u = ""; null !== (s = Ue.exec(o)); ) u += "-" + s[1];
            var l =
              (function (e) {
            ...
            return { name: l, styles: o, next: He };
          },
          ze = !!t.useInsertionEffect && t.useInsertionEffect,
          Be =
            ze ||
            function (e) {
              return e();
            },
          _e = (ze || t.useLayoutEffect, {}.hasOwnProperty),
          Ke = t.createContext(
        ...
        var We = function (e) {
          ...
          Ye = We(function (e, n, r) {
            ...
            var u = $e(a, void 0, t.useContext(Ge));
            s += n.key + "-" + u.name;
            var l = {};
            for (var c in e)
              _e.call(e, c) && "css" !== c && c !== qe && (l[c] = e[c]);
            return (
              (l.ref = r),
              (l.className = s),
              t.createElement(
        ...
        function ht(e) {
          ...
          let a = (i ? ct(n.width) : n.width) / r,
            s = (i ? ct(n.height) : n.height) / o;
          return (
        ...
        function Ot(e) {
          const t = (function (e) {
            ...
            const t =
              e.assignedSlot || e.parentNode || (at(e) && e.host) || yt(e);
        ...
        function wt(e, t) {
          ...
          const r = Ot(e),
            ...
            i = tt(r);
          return o
            ? t.concat(i, i.visualViewport || [], st(r) ? r : [])
            : t.concat(r, wt(r));
        }
        const St = t.useLayoutEffect;
        var xt = [
            "className",
            "clearValue",
            "cx",
        ...
        function Pt(e, t) {
          ...
          if (t && e)
            for (var a in t)
              t.hasOwnProperty(a) && t[a] && i.push("".concat(Ct(e, a)));
          return i
            .filter(function (e) {
              return e;
            })
        ...
        function Vt(e, t) {
          ...
          !(function t() {
            ...
            Mt(e, s), a < n ? window.requestAnimationFrame(t) : r(e);
          })();
        }
        function Dt(e, t) {
        ...
        At.addEventListener &&
          ...
          (At.addEventListener("p", kt, Ft),
          At.removeEventListener("p", kt, !1));
        var Ht = Tt;
        function Ut(e) {
          return null != e;
        }
        ...
        var _t,
          ...
          Jt = function (e) {
            var n = e.children,
              ...
              u = e.theme,
              c = ((0, t.useContext)(qt) || {}).setPortalPlacement,
              p = (0, t.useRef)(null),
              f = g((0, t.useState)(o), 2),
              d = f[0],
              h = f[1],
              v = g((0, t.useState)(null), 2),
              m = v[0],
              b = v[1],
              ...
              St(
                function () {
                  ...
                  if (e) {
                    ...
                    h(n.maxHeight), b(n.placement), null == c || c(n.placement);
                  }
                },
                [o, i, a, s, r, c, y]
              ),
          ...
          mn = {
            ...
            GroupHeading: function (e) {
              ...
              return Ze(
                "div",
                m({}, Rt(e, "groupHeading", { "group-heading": !0 }), n)
              );
            },
            IndicatorsContainer: function (e) {
              ...
              return Ze(
                "div",
                m({}, Rt(e, "indicatorsContainer", { indicators: !0 }), n),
                t
              );
            },
            ...
            Input: function (e) {
              ...
              return Ze(
                "div",
                m({}, Rt(e, "input", { "input-container": !0 }), {
                  "data-value": n || "",
                }),
                Ze(
                  "input",
            ...
            LoadingIndicator: function (e) {
              ...
              return Ze(
                ...
                Ze(cn, { delay: 0, offset: n }),
                Ze(cn, { delay: 160, offset: !0 }),
                Ze(cn, { delay: 320, offset: !n })
              );
            },
            Menu: function (e) {
              var t = e.children,
                                  ...
                                  (function a(s, u) {
                                    ...
                                    const d = {
                                      rootMargin:
                                        -pt(c) +
                                        "px " +
                                        -pt(o.clientWidth - (l + p)) +
                                        "px " +
                                        -pt(o.clientHeight - (c + f)) +
                                        "px " +
                                        -pt(l) +
                                        "px",
                                      threshold: lt(0, ut(1, u)) || 1,
                                    };
                                    let g = !0;
                                    function h(e) {
                                    ...
                                    try {
                                      ...
                                      r = new IntersectionObserver(h, d);
                                    }
                                    r.observe(e);
                                  })(!0),
                                  i
                ...
                m(
                  ...
                  Rt(
                    l(
                      l({}, e),
                      {},
                      { offset: b.offset, position: s, rect: b.rect }
                    ),
                    "menuPortal",
                    { "menu-portal": !0 }
                  ),
            ...
            Placeholder: function (e) {
              ...
              return Ze(
                "div",
                m({}, Rt(e, "placeholder", { placeholder: !0 }), n),
                t
              );
            },
        ...
        for (
          var On = {
            ...
            xn = function (e) {
              var n = e.ariaSelection,
                  ...
                  function () {
                    ...
                    if (n && x.onChange) {
                      var r = n.option,
                        ...
                        g = d ? d.map(f) : [],
                        v = l(
                          { isDisabled: c && h(c, s), label: p, labels: g },
                          n
                        );
                      t = x.onChange(v);
                    }
                ...
                L = "".concat(C, " ").concat(P, " ").concat(E),
                R = Ze(
                  t.Fragment,
                  null,
                  Ze("span", { id: "aria-selection" }, k),
                  Ze("span", { id: "aria-context" }, L)
                ),
                I = "initial-input-focus" === (null == n ? void 0 : n.action);
              return Ze(
                t.Fragment,
                null,
                Ze(wn, { id: c }, I && R),
          ...
          for (var Ln = kn[En], Rn = 0; Rn < Ln.letters.length; Rn++)
            Pn[Ln.letters[Rn]] = Ln.base;
        var In = function (e) {
        ...
        function Nn(e) {
          var t = e.innerRef,
            ...
            })(h(e, Dn), "onExited", "in", "enter", "exit", "appear");
          return Ze(
            "input",
            m({ ref: t }, n, {
              css: Qe(
                ...
                s = (0, t.useCallback)(
                  function (e) {
                    if (zn) {
                      ...
                      t &&
                        $n() &&
                        (t.addEventListener("touchmove", An, _n),
                        e &&
                          (e.addEventListener("touchstart", Un, _n),
                          e.addEventListener("touchmove", Hn, _n))),
                        (Bn += 1);
                    }
                  },
                  [o]
                  ...
                  function (e) {
                    if (zn) {
                      ...
                      (Bn = Math.max(Bn - 1, 0)),
                        ...
                        t &&
                          $n() &&
                          (t.removeEventListener("touchmove", An, _n),
                          e &&
                            (e.removeEventListener("touchstart", Un, _n),
                            e.removeEventListener("touchmove", Hn, _n)));
                    }
                  },
                  [o]
                );
          ...
          Yn = {
            ...
            loadingIndicator: function (e, t) {
              ...
              return l(
                ...
                t
                  ? {}
                  : { color: n ? i.neutral60 : i.neutral20, padding: 2 * a }
              );
            },
            loadingMessage: Zt,
            menu: function (e, t) {
        ...
        function nr(e, t) {
          var n = e.inputValue,
            ...
            a = t.label,
            s = t.value;
          return (!ur(e) || !i) && sr(e, { label: a, value: s, data: o }, r);
        }
        var rr = function (e, t) {
            ...
            function i(e) {
              ...
              if (
                ...
                (t.clearValue = function () {
                  ...
                  t.onChange($t(t.props.isMulti, [], null), {
                    action: "clear",
                    removedValues: e,
                  });
                }),
                ...
                (t.cx = function () {
                  for (
                    ...
                    n[r] = arguments[r];
                  return Pt.apply(void 0, [t.props.classNamePrefix].concat(n));
                }),
                ...
                (t.getComponents = function () {
                  return (e = t.props), l(l({}, mn), e.components);
                }),
                (t.buildCategorizedOptions = function () {
                  return er(t.props, t.state.selectValue);
                }),
                (t.getCategorizedOptions = function () {
                  return t.props.menuIsOpen ? t.buildCategorizedOptions() : [];
                }),
                (t.buildFocusableOptions = function () {
                  return tr(t.buildCategorizedOptions());
                }),
                (t.getFocusableOptions = function () {
                  return t.props.menuIsOpen ? t.buildFocusableOptions() : [];
                }),
                (t.ariaOnChange = function (e, n) {
                  t.setState({ ariaSelection: l({ value: e }, n) });
                }),
                ...
                (t.instancePrefix =
                  "react-select-" + (t.props.instanceId || ++lr)),
                (t.state.selectValue = Et(e.value)),
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return t.createElement(
                        e,
                        m({}, n, { innerProps: i, isDisabled: r, isFocused: o })
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e = this,
                        ...
                        P = d.menuShouldScrollIntoView,
                        E = d.noOptionsMessage,
                        L = d.onMenuScrollToTop,
                      ...
                      if (this.hasOptions())
                        I = this.getCategorizedOptions().map(function (n) {
                          if ("group" === n.type) {
                            var i = n.data,
                              a = n.options,
                              s = n.index,
                          ...
                          if ("option" === n.type)
                            return j(n, "".concat(n.index));
                        });
                      else if (v) {
                        var M = b({ inputValue: h });
                        if (null === M) return null;
                        I = t.createElement(u, p, M);
                      } else {
                        var V = E({ inputValue: h });
                        if (null === V) return null;
                        I = t.createElement(l, p, V);
                      }
                      var D = {
                          minMenuHeight: y,
                          maxMenuHeight: O,
                        ...
                        N = t.createElement(Jt, m({}, p, D), function (n) {
                          var r = n.ref,
                            o = n.placerProps,
                            s = o.placement,
                            u = o.maxHeight;
                    ...
                    value: function (e, t) {
                      ...
                      return (
                        a &&
                          !w &&
                          ((O = {
                            value: $t(d, g, g[0] || null),
                            options: g,
                            action: "initial-input-focus",
                          }),
                          (w = !s)),
                        "initial-input-focus" ===
                          (null == i ? void 0 : i.action) && (O = null),
                        l(
                          l(l({}, h), y),
                          {},
                          { prevProps: e, ariaSelection: O, prevWasFocused: w }
                        )
                      );
                    },
                  },
        ...
        cr.defaultProps = Zn;
        var pr = (0, t.forwardRef)(function (e, n) {
            var r = (function (e) {
              var n = e.defaultInputValue,
                ...
                b = e.value,
                y = h(e, v),
                O = g((0, t.useState)(void 0 !== u ? u : r), 2),
                w = O[0],
                S = O[1],
                x = g((0, t.useState)(void 0 !== c ? c : i), 2),
                k = x[0],
                C = x[1],
                P = g((0, t.useState)(void 0 !== b ? b : s), 2),
                E = P[0],
                L = P[1],
                R = (0, t.useCallback)(
                  function (e, t) {
                    "function" == typeof p && p(e, t), L(e);
                  },
                  [p]
                ),
                I = (0, t.useCallback)(
            ...
            return t.createElement(cr, m({ ref: n }, r));
          }),
          fr = pr,
          dr =
        ...
        function Cr() {
          for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
            t[n] = arguments[n];
          ("string" == typeof t[0] && kr[t[0]]) ||
            ("string" == typeof t[0] && (kr[t[0]] = new Date()),
            xr.apply(void 0, t));
        }
        function Pr(e, t, n) {
        ...
        function Rr(e) {
          var n =
            ...
            s = r || i || br;
          if (
            (s && !s.reportNamespaces && (s.reportNamespaces = new wr()), !s)
          ) {
            Cr(
          ...
          var c = Lr(Lr(Lr({}, yr), s.options.react), n),
            p = c.useSuspense,
            f = c.keyPrefix,
            ...
            d.every(function (e) {
              return (function (e, t) {
                ...
                return t.languages && t.languages.length
                  ...
                  : (Cr("i18n.languages were undefined or empty", t.languages),
                    !0);
              })(e, s, c);
            });
          function v() {
            return s.getFixedT(null, "fallback" === c.nsMode ? d : d[0], f);
          }
          var m,
            b,
            y,
            O = g((0, t.useState)(v), 2),
            w = O[0],
            S = O[1],
            x = d.join(),
            k =
          ...
          (0, t.useEffect)(
            function () {
              C.current && !P.current && S(v), (P.current = !1);
            },
            [s, f]
          );
          var E = [w, s, h];
          if (((E.t = w), (E.i18n = s), (E.ready = h), h)) return E;
          if (!h && !p) return E;
              ...
              O(o, [
                ...
                },
                {
                  ...
                  value: function (e, t, n) {
                    ...
                    var s = Ur(this.data, a);
                    return s || !i || "string" != typeof n
                      ? s
                      : Yr(this.data && this.data[e] && this.data[e][t], n, o);
                  },
                },
                {
                  key: "addResource",
                    ...
                    value: function (e, t, n) {
                      ...
                      if (f && "cimode" === f.toLowerCase()) {
                        if (d) {
                          ...
                          return a
                            ? ((h.res = "".concat(p).concat(g).concat(l)), h)
                            : "".concat(p).concat(g).concat(l);
                        }
                      ...
                      if (
                        ...
                        ("string" != typeof O || "[object Array]" !== y)
                      ) {
                        ...
                        if (s) {
                          ...
                          for (var P in v)
                            if (Object.prototype.hasOwnProperty.call(v, P)) {
                              var E = "".concat(C).concat(s).concat(P);
                              (k[P] = this.translate(
                                E,
                                eo(eo({}, t), { joinArrays: !1, ns: c })
                              )),
                                k[P] === E && (k[P] = v[P]);
                            }
                          v = k;
                        ...
                        var L = !1,
                          ...
                          j = i.hasDefaultValue(t),
                          M = I
                            ? this.pluralResolver.getSuffix(f, t.count, t)
                            : "",
                          V = t["defaultValue".concat(M)] || t.defaultValue;
                        !this.isValidLookup(v) && j && ((L = !0), (v = V)),
                        ...
                        var D =
                            ...
                            R
                              ? void 0
                              : v,
                          N = j && V !== v && this.options.updateMissing;
                        if (R || L || N) {
                          if (
                            (this.logger.log(
                          ...
                          if (
                            ...
                            for (var H = 0; H < A.length; H++) F.push(A[H]);
                          else
                          ...
                          var U = function (e, n, r) {
                            ...
                            o.options.missingKeyHandler
                              ? o.options.missingKeyHandler(e, p, n, i, N, t)
                              : o.backendConnector &&
                    ...
                    value: function (e, t, n, r, o) {
                      ...
                      if (this.i18nFormat && this.i18nFormat.parse)
                        e = this.i18nFormat.parse(
                          e,
                          eo(
                            eo({}, this.options.interpolation.defaultVariables),
                            n
                          ),
                          r.usedLng,
                          r.usedNS,
                        ...
                        e.forEach(function (e) {
                          if (!a.isValidLookup(t)) {
                            ...
                            c.forEach(function (e) {
                              a.isValidLookup(t) ||
                                ((i = e),
                                !to["".concat(g[0], "-").concat(e)] &&
                                  a.utils &&
                                  a.utils.hasLoadedNamespace &&
                                  !a.utils.hasLoadedNamespace(i) &&
                                  ((to["".concat(g[0], "-").concat(e)] = !0),
                                  a.logger.warn(
                                    'key "'
                                ...
                                g.forEach(function (n) {
                                  if (!a.isValidLookup(t)) {
                                    ...
                                    if (
                                      ...
                                      a.i18nFormat.addLookupKeys(u, l, n, e, s);
                                    else {
                                      var c;
                                      p &&
        ...
        var oo = (function () {
            function e(t) {
              b(this, e),
                ...
                (this.logger = Dr.create("languageUtils"));
            }
            return (
              O(e, [
                {
          ...
          so = ["v1", "v2", "v3"],
          uo = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
          lo = (function () {
            function e(t) {
              var n,
                r =
              ...
              b(this, e),
                ...
                (this.options = r),
                (this.logger = Dr.create("pluralResolver")),
                ...
                (this.rules =
                  ...
                  io.forEach(function (e) {
                    e.lngs.forEach(function (t) {
                      n[t] = { numbers: e.nr, plurals: ao[e.fc] };
                    });
                  }),
                  n));
            }
          ...
          function e() {
            var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
            b(this, e),
              (this.logger = Dr.create("interpolator")),
              (this.options = t),
              (this.format =
            ...
            O(e, [
              {
                ...
                value: function () {
                  ...
                  (this.escape = void 0 !== t.escape ? t.escape : Kr),
                    (this.escapeValue =
                    ...
                    (this.nestingPrefix = t.nestingPrefix
                      ? Br(t.nestingPrefix)
                      : t.nestingPrefixEscaped || Br("$t(")),
                    (this.nestingSuffix = t.nestingSuffix
                      ? Br(t.nestingSuffix)
                      : t.nestingSuffixEscaped || Br(")")),
                ...
                value: function (e, t, n, r) {
                  ...
                  var c = function (e) {
                    if (e.indexOf(s.formatSeparator) < 0) {
                      ...
                      return s.alwaysFormat
                        ? s.format(
                            ...
                            void 0,
                            n,
                            po(po(po({}, r), t), {}, { interpolationkey: e })
                          )
                        : o;
                    }
                    ...
                    return s.format(
                      ...
                      l,
                      n,
                      po(po(po({}, r), t), {}, { interpolationkey: a })
                    );
                  };
                  this.resetRegExp();
                  var p =
                      ...
                      l &&
                        (r = u.reduce(function (e, t) {
                          return o.format(
                            ...
                            t,
                            i.lng,
                            po(po({}, i), {}, { interpolationkey: n[1].trim() })
                          );
                        }, r.trim())),
                      (e = e.replace(n[0], r)),
          ...
          function e() {
            var t =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
            b(this, e),
              (this.logger = Dr.create("formatter")),
              (this.options = t),
              (this.formats = {
                number: vo(function (e, t) {
                  var n = new Intl.NumberFormat(e, t);
                  return function (e) {
                    return n.format(e);
                  };
                }),
                currency: vo(function (e, t) {
                  var n = new Intl.NumberFormat(
                    e,
                    ho(ho({}, t), {}, { style: "currency" })
                  );
                  return function (e) {
                    return n.format(e);
                  };
                }),
                datetime: vo(function (e, t) {
                  var n = new Intl.DateTimeFormat(e, ho({}, t));
                  return function (e) {
                    return n.format(e);
                  };
                }),
                relativetime: vo(function (e, t) {
                  var n = new Intl.RelativeTimeFormat(e, ho({}, t));
                  return function (e) {
                    return n.format(e, t.range || "day");
                  };
                }),
                list: vo(function (e, t) {
                  var n = new Intl.ListFormat(e, ho({}, t));
                  return function (e) {
                    return n.format(e);
                  };
                }),
                    ...
                    if (o.formats[a]) {
                      ...
                      try {
                        var l =
                            ...
                            {},
                          p = l.locale || l.lng || r.locale || r.lng || n;
                        u = o.formats[a](e, p, ho(ho(ho({}, s), r), l));
                      } catch (e) {
                        o.logger.warn(e);
                      }
                      return u;
        ...
        var Oo = (function (e) {
          ...
          function o(e, t, n) {
            ...
            return (
              ...
              (i.options = a),
              (i.logger = Dr.create("backendConnector")),
              (i.waitingReads = []),
        ...
        var Co = (function (e) {
          ...
          function i() {
            ...
            if (
              ...
              if (!e.options.initImmediate) return e.init(n, r), C(e, k(e));
              setTimeout(function () {
                e.init(n, r);
              }, 0);
            }
            ...
            O(i, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ((this.options = xo(xo(xo({}, o), this.options), wo(t))),
                    "v1" !== this.options.compatibilityAPI &&
                      (this.options.interpolation = xo(
                        xo({}, o.interpolation),
                        this.options.interpolation
                      )),
                    void 0 !== t.keySeparator &&
                    ...
                    var a;
                    this.modules.logger
                      ? Dr.init(i(this.modules.logger), this.options)
                      : Dr.init(null, this.options),
                      this.modules.formatter
                        ? (a = this.modules.formatter)
                        : "undefined" != typeof Intl && (a = mo);
                    var s = new oo(this.options);
                    this.store = new Xr(this.options.resources, this.options);
                    var u = this.services;
                    (u.logger = Dr),
                      (u.resourceStore = this.store),
                      (u.languageUtils = s),
                      (u.pluralResolver = new lo(s, {
                      ...
                      (u.interpolator = new fo(this.options)),
                      (u.utils = {
                        hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
                      }),
                      (u.backendConnector = new Oo(
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    ...
                    "postProcessor" === e.type && Zr.addPostProcessor(e),
                  ...
                  var e = this,
                    ...
                    n =
                      arguments.length > 1 && void 0 !== arguments[1]
                        ? arguments[1]
                        : ko,
                    r = xo(xo(xo({}, this.options), t), { isClone: !0 }),
                    o = new i(r);
                  return (
                    ...
                    (o.services = xo({}, this.services)),
                    (o.services.utils = {
                      hasLoadedNamespace: o.hasLoadedNamespace.bind(o),
                    }),
                    (o.translator = new no(o.services, o.options)),
        ...
        s(Co, "createInstance", function () {
          return new Co(
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            arguments.length > 1 ? arguments[1] : void 0
          );
        });
        var Po = Co.createInstance();
        (Po.createInstance = Co.createInstance),
          Po.createInstance,
          Po.init,
          Po.loadResources,
          Po.reloadResources,
          ...
          Po.t,
          Po.exists,
          Po.setDefaultNamespace,
          Po.hasLoadedNamespace,
          Po.loadNamespaces,
          Po.loadLanguages;
        const Eo = Po;
        function Lo(e, t) {
        ...
        var Ro = function (e) {
          console.log("Set languages", e),
            Eo.loadLanguages(e)
              .then(function (t) {
                var n;
                console.log("All at once languages", t),
                  console.log("i18n languages", Eo.languages),
                  (Eo.language =
                    (function (e) {
                  ...
                  console.log("i18n after update", Eo.languages);
              })
              .catch(function (e) {
                console.log("Loading new Languages has failed", e);
              });
        };
        function Io(e, t) {
          return (
        ...
        var Mo = n().createContext(null),
          Vo = function (e) {
            var r = Rr(),
              o = r.t,
              i = r.i18n,
              a = Io((0, t.useState)(e.language || i.language), 2),
              s = a[0],
              u = a[1],
              l = e.children,
              c = e.ln,
              p = e.translations,
              f = Io((0, t.useState)(null), 2),
              d = f[0],
              g = f[1];
            return (
              console.log("PROVIDER TRANSLATIONS", e),
              console.log("children", l),
              console.log("ln", c),
              (0, t.useEffect)(function () {
                !(function (e) {
                  console.log("The langs to ADDLANGUAGES", e);
                  var t = [];
                  e.forEach(function (e) {
                    console.log("forEACHELEMENT");
                    var n = e.locale,
                      r = e.trans;
                    console.log("THE LOCALE", n),
                      console.log("'trans", r),
                      console.log("JSONSTRINGIFIED;;;", JSON.stringify(r)),
                      Eo.addResourceBundle(n, "translations", r, !1, !1),
                      t.push(n);
                  }),
                    Ro(t);
                })(p),
              ...
              (0, t.useEffect)(
                function () {
                  console.log("UpdateLanguages updated", d),
                    console.log("NewLanguages;;;", i.languages);
                },
                [d]
              ),
              n().createElement(
                Mo.Provider,
                {
                  value: {
                    language: s,
                    changeCurrentLanguage: function (e) {
                      i.changeLanguage(e, function () {
                        u(e);
                      });
                    },
                    get: function () {
                      var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ...
                          : "";
                      return (
                        console.log("GET MESSAGE;;;", e), console.log(o), o(e)
                      );
                    },
                    getLanguageNames: function () {
                      return p.map(function (e) {
                        return { name: e.label, locale: e.locale };
                      });
                    },
                  },
                },
        ...
        const Ao = function () {
          console.log("KOTII-UTILS VALUE;;;", e.capitalizeFirstLetter);
          var r = Do(),
            o = r.changeCurrentLanguage,
            i = r.language,
            a = r.getLanguageNames,
            s = No((0, t.useState)(i), 2),
            u = s[0],
            l = s[1],
            c = No((0, t.useState)([]), 2),
            p = c[0],
              ...
              f(
                (function (e) {
                  ...
                  (t = a().map(function (t) {
                    return {
                      value: t.locale,
                      label: (0, e.capitalizeFirstLetter)(t.name),
                    };
                  }))
                ) ||
                  (function (e) {
