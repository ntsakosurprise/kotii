...
const App = function () {
  ...
  const effectsStore = window?.__KOTII_EFFECTS_STATE__ ? JSON.parse(window.__KOTII_EFFECTS_STATE__) : null;
...
export { Head, Image, Svg, useAppContext, useUniversalEffect } from "../../react-components-pruned/index.js";
export { ServerApp };
export default App;