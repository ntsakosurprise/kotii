  ...
  return {
    ...
    Rule:(ruleNode)=>{
      ...
      if(selectorName[0] === "."){
        ...
        let scopedClassName = `${selectorName}_${createRandomName(5)}_${createRandomName(3)}`
        cssFileStylesMap[nameWithoutPeriod] = scopedClassName.substr(1,scopedClassName.length)
