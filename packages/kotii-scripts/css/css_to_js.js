...
const renderCssModules = function (cssInput, opts, moduleMeta,isModules=false) {
  ...
  return new Promise((resolve) => {
    ...
    mergeCssFiles(cssInput, moduleMeta).then((mergeResults)=>{
      ...
      console.log("IS MODULES IS TRUE", isModules)
        ...
        .then((result) => {
          ...
          resolve({ css: result.css, cssModules: opts[shortName], cssAst: copiedAst});
        });
      }).catch((err)=>{
