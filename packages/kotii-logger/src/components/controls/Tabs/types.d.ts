...
import { Align, BaseProps, ButtonType, GrowShrink, Target } from "../../../types";
export interface PageHeaderProps extends Omit<BaseProps, "children" | "hoverIndicator" | "flex" | "justify"> {
    gridArea?: string;
    disabled?: boolean;
    href?: string;
    icon?: ReactElement;
